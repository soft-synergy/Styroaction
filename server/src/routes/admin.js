    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, Admin_1.default.findOne({ username: username })];
            case 1:
                admin = _b.sent();
                if (!admin) {
            ...
            case 2:
                ...
                token = jsonwebtoken_1.default.sign({ id: admin._id, username: admin.username }, JWT_SECRET, { expiresIn: '7d' });
                res.json({ token: token, admin: { id: admin._id, username: admin.username, email: admin.email } });
                return [3 /*break*/, 4];
            case 3:
                error_1 = _b.sent();
...
router.post('/register', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, email, password, admin, savedAdmin, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
            ...
            case 2:
                ...
                if (error_2.code === 11000) {
                    return [2 /*return*/, res.status(400).json({ error: 'Admin with this username or email already exists' })];
                }
